...
def test_get_all_configs():
    ...
    rel_sub_config = ConfigParser.RawConfigParser()
    rel_sub_config.add_section(rel_sub_test_section)
    rel_sub_config.set(rel_sub_test_section, test_key, test_val)

    config_path = os.path.dirname(config_filename)
    rel_sub_config_file, rel_sub_config_filename = tempfile.mkstemp(dir=config_path)
    os.close(rel_sub_config_file)
    rel_sub_config_file = open(rel_sub_config_filename, "wb")
    rel_sub_config.write(rel_sub_config_file)
    rel_sub_config_file.close()
    ...
    config.set("otherconfs", rel_sub_test_section, os.path.basename(rel_sub_config_filename))
    ...
    assert cfg.get("otherconfs", rel_sub_test_section) == os.path.basename(rel_sub_config_filename)
